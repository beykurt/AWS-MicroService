    ...
    public class AdvertManagementController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateAdvertViewModel model, IFormFile imageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                var apiCallResponse = await _advertApiClient.CreateAsync(createAdvertModel).ConfigureAwait(continueOnCapturedContext: false);
                ...
                if (imageFile != null)
                {
                    ...
                    try
                    {
                        ...
                        var canConfirm = await _advertApiClient.ConfirmAsync(confirmModel).ConfigureAwait(continueOnCapturedContext: false);
                        if (!canConfirm)
                        {
